                    ...
                    <div className='container'>
                        <div id='form-rows' className='row'>
                            <div className='col-12'>
                                ...
                                <textarea placeholder='Enter privacy and policy' value={privacy_policy} onChange={(e) => setprivacy_policy(e.target.value)} />
                            </div>
                        </div>
                        <div id='form-rows' className='row'>
                            <div className='col-4'>
                        ...
                        <div className='table-print-section'>
                            <button onClick={() => {
                                if (Array.isArray(data) && data.length > 0) {
                                    setprivacy_policy(data[0].privacy_policy);
                                    setShowPopup(true);
                                } else if (data.privacy_policy) {
                                    setprivacy_policy(data.privacy_policy);
                                    setShowPopup(true);
                                } else {
                                    console.log('No privacy_policy found');
                                }
                                setShowPopup(true);
                            }}>Update</button>
                        </div>
