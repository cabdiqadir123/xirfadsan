...
function Earnings() {
    ...
    const filteredData = data.filter(item => {
        ...
        return matchesSearch && isWithinDateRange && matchesStatus && matchesStaff;
                            ...
                            <tbody>
                                {currentData.map((item) => (
                                    <tr key={item.id}>
                                        ...
                                        <td>
                                            <button className='btn-status border-2 border border-success text-success'><GrCheckmark /></button>
                                            {/* <button className='btn-status border-2 border border-danger text-danger'><BiPowerOff/></button> */}
                                        </td>
                                    </tr>
                                ))}
                            </tbody>
